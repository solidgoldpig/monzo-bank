;(function () {
   ...
   *     })
   *
   * @see https://getmonzo.co.uk/docs/#acquiring-an-access-token
   */
   ...
   *
   * @see https://getmonzo.co.uk/docs/#authenticating-requests
   */
   ...
   *     })
   *
   * @see https://getmonzo.co.uk/docs/#refreshing-access
   */
   ...
   *
   * @see https://getmonzo.co.uk/docs/#list-accounts
   */
   ...
   *
   * @see https://getmonzo.co.uk/docs/#read-balance
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#list-transactions
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#retrieve-transaction
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#annotate-transaction
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#create-feed-item
   */
   ...
   *
   * See https://getmonzo.co.uk/docs/#transaction-created for details of the transaction.created event which is sent to the webhook each time a new transaction is created in a user’s account
   *
   * @see https://getmonzo.co.uk/docs/#registering-a-web-hook
   */
   ...
   *
   * @see https://getmonzo.co.uk/docs/#list-web-hooks
   */
   ...
   *
   * @see https://getmonzo.co.uk/docs/#deleting-a-web-hook
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#register-attachment
   */
   ...
   *     }, access_token)
   *
   * @see https://getmonzo.co.uk/docs/#upload-attachment
   * @param {object} params params object
   ...
   *
   * @see https://getmonzo.co.uk/docs/#deregister-attachment
   */
